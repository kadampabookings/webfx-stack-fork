...
final class VertxHttpRouterConfigurator {
    ...
    static Router initialiseRouter() {
        ...
        // NOTE: a "/proxy/*" route used to be registered here, forwarding any caller-supplied URL
        // with setTrustAll(true) and Access-Control-Allow-Origin: *. Unauthenticated, it reached the
        // cloud instance metadata endpoint and everything else inside the VPC. Removed 2026-08-23.
        // Do not reinstate it from upstream: a forwarder here must allowlist target hosts and
