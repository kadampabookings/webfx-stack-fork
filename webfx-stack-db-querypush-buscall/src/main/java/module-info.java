...
module webfx.stack.db.querypush.buscall {
    ...
    // Provided services
    provides dev.webfx.stack.com.bus.call.spi.BusCallEndpoint with dev.webfx.stack.db.querypush.buscall.ArmSqlAnalyzeMethodEndpoint, dev.webfx.stack.db.querypush.buscall.CancelSqlQueryMethodEndpoint, dev.webfx.stack.db.querypush.buscall.ExecuteQueryPushMethodEndpoint, dev.webfx.stack.db.querypush.buscall.GetQueryPushMonitorInfoMethodEndpoint, dev.webfx.stack.db.querypush.buscall.GetSqlAnalyzeResultMethodEndpoint, dev.webfx.stack.db.querypush.buscall.ResetSqlMonitorMethodEndpoint;
